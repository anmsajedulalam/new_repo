...
class Config:
    ...
    AZURE_OPENAI_API_KEY = os.getenv("AZURE_OPENAI_API_KEY", "DhkjcN2rmebPTe2Y3xcvzcsnfsDVQEcl710CnEdyhuNc97mHlEq9JQQJ99BLACHYHv6XJ3w3AAAAACOGhUVi")
    AZURE_OPENAI_ENDPOINT = os.getenv("AZURE_OPENAI_ENDPOINT", "https://assessment-test-3-found-resource.cognitiveservices.azure.com/")
    ...
    AZURE_DEPLOYMENT_NAME = os.getenv("AZURE_DEPLOYMENT_NAME", "gpt-4.1-mini") # Guessing based on "gpt-4.1-min..."
    ...
    TAVILY_API_KEY = os.getenv("TAVILY_API_KEY", "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")
